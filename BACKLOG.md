...
- [x] 2026-08-20 — **Correcciones post-informe de agentes**: los microdatos refutaron 2 hipótesis — Arquitectura 2025-2/2026-1 va sobre 1,845 (su CALIF_FINAL NO incluye vocacional; corregida la comparativa de Finales que usaba 2,445) y sexo viene como MASCULINO/FEMENINO (mapeado a F/M). 2 registros sucios de 2025-2 (>1,845) descartados en vez de clamp (adiós nota 20.00 falsa; Civil 2025-2 máx real 19.79). Variante sin tilde AEROESPACIAL colapsada a la forma correcta (que era la minoritaria).
- [x] 2026-08-20 — **Serie histórica 2021→2026-2 integrada** (fase 1 de datos abiertos, hecha con 3 agentes en paralelo): CSV oficiales descargados a `uniexamen/historico/` (21MB); `build_stats.py` genera `serie_historica` (11 procesos: postulantes/ingresantes, por sexo, nota mín/máx vigesimal por carrera SOLO ordinario; escala vigesimal ≤2025-1, /1845 después, Arq /2445; fallback a previo en CI). Sección nueva "#historia": tiles, postulantes vs ingresantes por proceso (con 2026-2), **comparativo histórico de nota mínima por carrera** (12 columnas), brecha de género, FAQ y bot. Validado: 2021-1 5290/825, 2026-1 6114/1319, Civil 11.03→13.93→12.9, 0 notas fuera de rango.

## Pendiente
- [ ] **Fase 2 datos históricos**: integrar `historico/serie_pdf.json` (agente wayback-pdfs rescatando 27 PDFs 2013-2025 de Wayback) para extender la serie de postulantes/ingresantes a 2013; validar contra CSV en años solapados.
